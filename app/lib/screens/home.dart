...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _sendMessage() async {
    // Create a message map with text and sender information
    Map<String, dynamic> messageData = {
      'message': _messageInputController.text.trim(),
      'sender': widget.username,
    };

    // Check if a file is selected and add it to the message map
    if (pickedFile != null) {
                        ...
                        prefixIcon: InkWell(
                            onTap: () async {
                              ...
                              setState(() {
                                ...
                                _messageInputController.text = pickedFile!.name;
                              });
                            },
